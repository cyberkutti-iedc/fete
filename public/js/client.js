...
const welcomeImg = '../images/placeholder.png';
const shareUrlImg = '../images/placeholder.png';
...
function showAbout() {
    ...
    Swal.fire({
        background: swalBackground,
        position: 'center',
        title: '<strong>IEDC SNMIMT</strong>',
        imageAlt: 'IEDC SNMIMT',
        imageUrl: aboutImg,
        html: `
        <br/>
        <div id="about">
            ...
            <br/><br/>
            <button class="pulsate umami--click--sponsor" onclick="window.open('#')"><i class="${className.heart}" ></i>&nbsp;Support</button>
            <br /><br />
            Author:<a href="#" class="umami--click--linkedin" target="_blank"> SREERAJ V RAJRSH</a>
        </div>
        `,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your Feta experience?',
        confirmButtonText: `Yes`,
        denyButtonText: `No`,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
